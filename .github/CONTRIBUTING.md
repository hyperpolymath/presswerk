...
git clone <https://github.com/hyperpolymath/presswerk.git> cd presswerk
...
toolbox create presswerk-dev toolbox enter presswerk-dev \# Install
...
presswerk/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/presswerk/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/presswerk/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/presswerk/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/presswerk/labels/perimeter-3) — Community sandbox scope
