...
// Replace presswerk, Presswerk — See README.adoc for details., just run, Presswerk started successfully. with actuals
= presswerk — Quick Start for Users
:toc:
:toclevels: 2

== What is presswerk?

Presswerk — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./presswerk-portable
----
...
[source]
----
Presswerk started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/presswerk/wiki
