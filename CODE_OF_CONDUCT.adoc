...
Presswerk a harassment-free experience for everyone, regardless of age,
...
. The Presswerk maintainers will review the report
...
The Presswerk maintainers will follow these guidelines in determining
consequences:
...
* Appeals are reviewed by a different Presswerk maintainers member than
the original
...
* Open a
https://github.com/hyperpolymath/presswerk/discussions[Discussion] (for
general questions)
